...
static void compare_growth(int model, struct growth_data * data)
{
  ...
  ccl_parameters params = ccl_parameters_create(data->Omega_c, data->Omega_b, 
						...
						data->h, data->A_s, data->n_s,-1,NULL,NULL,0);
  params.Omega_g=0;
...
static void check_mgrowth(void)
{
  ...
  params1=ccl_parameters_create(0.25,0.05,0,0,-1,0,0.7,2.1E-9,0.96,-1,NULL,NULL,0);
  params2=ccl_parameters_create(0.25,0.05,0,0,-1,0,0.7,2.1E-9,0.96,nz_mg,z_mg,df_mg,0);
