...
ccl_cosmology * ccl_cosmology_create_with_params(
	...
	double fNL,ccl_configuration config)
{
...
ccl_parameters ccl_parameters_create(double Omega_c, double Omega_b, double Omega_k, double Omega_n,
				     double w0, double wa, double h, double norm_pk, double n_s,
				     int nz_mgrowth,double *zarr_mgrowth,double *dfarr_mgrowth, double fNL)
{
  ccl_parameters params;
  params.sigma_8 = NAN;
  params.A_s = NAN;
...
ccl_parameters ccl_parameters_create_flat_lcdm(double Omega_c, double Omega_b, double h, double norm_pk, double n_s)
{
  ...
  double w0 = -1.0;
  double wa = 0.0;
  ccl_parameters params = ccl_parameters_create(Omega_c, Omega_b, Omega_k, Omega_n, w0, wa, h, norm_pk, n_s, -1, NULL, NULL,0);
  return params;
